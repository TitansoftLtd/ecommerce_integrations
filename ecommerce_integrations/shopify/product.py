...
def upload_erpnext_item(doc, method=None):
	...
	# Sync To Shopify and product title live on the template (or single item), not on variants
	...
	# resolve option values before calling Shopify so incomplete variants do not leave a half-built product
